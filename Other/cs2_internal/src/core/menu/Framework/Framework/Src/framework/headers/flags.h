...
inline gui_style::gui_style()
{
    ...
    colors[style_col_window_bg] = ImVec4(0.114f, 0.114f, 0.129f, 0.94f);  
    colors[style_col_child_bg] = ImVec4(0.114f, 0.114f, 0.129f, 1.00f);  
    colors[style_col_popup_bg] = ImVec4(0.114f, 0.114f, 0.129f, 0.94f);  
    colors[style_col_border] = ImVec4(0.718f, 0.580f, 0.957f, 0.50f);  
    colors[style_col_border_shadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[style_col_frame_bg] = ImVec4(0.114f, 0.114f, 0.129f, 0.54f);  
    colors[style_col_frame_bg_hovered] = ImVec4(0.718f, 0.580f, 0.957f, 0.40f);  
    colors[style_col_frame_bg_active] = ImVec4(0.718f, 0.580f, 0.957f, 0.67f);  
    colors[style_col_title_bg] = ImVec4(0.114f, 0.114f, 0.129f, 1.00f);  
    colors[style_col_title_bg_active] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_title_bg_collapsed] = ImVec4(0.114f, 0.114f, 0.129f, 0.51f);  
    colors[style_col_menu_bar_bg] = ImVec4(0.114f, 0.114f, 0.129f, 1.00f);  
    colors[style_col_scrollbar_bg] = ImVec4(0.114f, 0.114f, 0.129f, 0.53f);  
    colors[style_col_scrollbar_grab] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_scrollbar_grab_hovered] = ImVec4(0.798f, 0.698f, 0.988f, 1.00f);  
    colors[style_col_scrollbar_grab_active] = ImVec4(0.638f, 0.460f, 0.918f, 1.00f);  
    colors[style_col_check_mark] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_slider_grab] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_slider_grab_active] = ImVec4(0.798f, 0.698f, 0.988f, 1.00f);  
    colors[style_col_button] = ImVec4(0.718f, 0.580f, 0.957f, 0.40f);  
    colors[style_col_button_hovered] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_button_active] = ImVec4(0.638f, 0.460f, 0.918f, 1.00f);  
    colors[style_col_header] = ImVec4(0.718f, 0.580f, 0.957f, 0.31f);  
    colors[style_col_header_hovered] = ImVec4(0.718f, 0.580f, 0.957f, 0.80f);  
    colors[style_col_header_active] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_separator] = colors[style_col_border];
    colors[style_col_separator_hovered] = ImVec4(0.718f, 0.580f, 0.957f, 0.78f);  
    colors[style_col_separator_active] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_resize_grip] = ImVec4(0.718f, 0.580f, 0.957f, 0.20f);  
    colors[style_col_resize_grip_hovered] = ImVec4(0.718f, 0.580f, 0.957f, 0.67f);  
    colors[style_col_resize_grip_active] = ImVec4(0.718f, 0.580f, 0.957f, 0.95f);  
    ...
    colors[style_col_tab_dimmed_selected_overline] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_plot_lines] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_plot_lines_hovered] = ImVec4(0.798f, 0.698f, 0.988f, 1.00f);  
    colors[style_col_plot_histogram] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_plot_histogram_hovered] = ImVec4(0.798f, 0.698f, 0.988f, 1.00f);  
    colors[style_col_table_header_bg] = ImVec4(0.114f, 0.114f, 0.129f, 1.00f);  
    colors[style_col_table_border_strong] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_table_border_light] = ImVec4(0.718f, 0.580f, 0.957f, 0.50f);  
    colors[style_col_table_row_bg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[style_col_table_row_bg_alt] = ImVec4(0.718f, 0.580f, 0.957f, 0.06f);  
    colors[style_col_text_link] = colors[style_col_header_active];
    colors[style_col_text_selected_bg] = ImVec4(0.718f, 0.580f, 0.957f, 0.35f);  
    colors[style_col_drag_drop_target] = ImVec4(0.718f, 0.580f, 0.957f, 0.90f);  
    colors[style_col_nav_highlight] = ImVec4(0.718f, 0.580f, 0.957f, 1.00f);  
    colors[style_col_nav_windowing_highlight] = ImVec4(0.798f, 0.698f, 0.988f, 0.70f);  
    colors[style_col_nav_windowing_dim_bg] = ImVec4(0.114f, 0.114f, 0.129f, 0.20f);  
    colors[style_col_modal_window_dim_bg] = ImVec4(0.114f, 0.114f, 0.129f, 0.35f);  
