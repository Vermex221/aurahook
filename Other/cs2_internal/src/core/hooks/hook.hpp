...
namespace hooks {
	...
	public:
		...
		static void __fastcall aggregate_draw_array( std::uintptr_t thisptr, std::uintptr_t a2, std::uintptr_t mesh_array, int mesh_count, int a5, std::uintptr_t a6, std::uintptr_t a7, std::uintptr_t a8 );
		...
		static std::uint8_t __fastcall world_material_swap_active( );
		static std::uintptr_t __fastcall force_world_material_rcx( std::uintptr_t mesh_entry );
		...
		static std::uint32_t __fastcall get_weapon_type( std::uintptr_t entity );
		static ID3D11ShaderResourceView* __fastcall get_resource_view( void* texture_manager, int** texture, char a3, char a4, const char* a5 );
		...
		static bool __fastcall weapon_hides_crosshair( std::uintptr_t zoom_data );
		...
		static void __fastcall viewmodel_update_and_setup_view( std::uintptr_t viewmodel, void* position, void* angles, bool update );
		static void* __fastcall particle_draw_array( std::int64_t a1, std::int64_t a2, __m128* a3, unsigned long long* a4, void* a5 );

	private:
		inline static hooking::jmp m_present{};
		inline static hooking::jmp m_resize_buffers{};
		inline static WNDPROC m_wnd_proc_orig{};
		inline static HWND m_wnd_proc_hwnd{};
		...
		inline static hooking::jmp m_aggregate_draw_array{};
		...
		inline static hooking::jmp m_force_vis_material_branch{};
		inline static void* m_force_vis_material_branch_stub{};
		inline static hooking::jmp m_force_world_material{};
		inline static void* m_force_world_material_stub{};
		inline static std::uintptr_t m_force_vis_label76{};
		...
		inline static hooking::jmp m_get_weapon_type{};
		...
		inline static hooking::jmp m_weapon_hides_crosshair{};
		...
		inline static hooking::jmp m_viewmodel_update_and_setup_view{};
		inline static hooking::jmp m_particle_draw_array{};
	};
