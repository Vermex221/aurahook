...
namespace ImAdd
{
	...
	bool    SelectableFrameIcon(const char* str_id, ImTextureID icon_texture, bool* active, const ImVec2& size = ImVec2(0, 0), const ImVec2& icon_padding = ImVec2(0, 0));
	...
	void	KeyBindPopup(const char* str_id, int* k, int* mode);
}
